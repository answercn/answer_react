...
exports.fetchJsonp = exports.fetchPost = exports.fetchGet = undefined;

var _fetchJsonp = __webpack_require__(1214);

var _fetchJsonp2 = _interopRequireDefault(_fetchJsonp);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

__webpack_require__(1215).polyfill();
__webpack_require__(1217);
//mport '../../node_modules/whatwg-fetch';
//import Promise from '../../node_modules/promise-polyfill';


var fetchCore = function fetchCore(type, url, param, callback, errorCb) {
...
var fetchGet = function fetchGet() {
    ...
    fetchCore.apply(undefined, ["GET"].concat(arg));
};
//post
var fetchPost = function fetchPost() {
    ...
    fetchCore.apply(undefined, ["POST"].concat(arg));
};
//jsonp
var fetchJsonp = function fetchJsonp() {
    (0, _fetchJsonp2.default)('/users.jsonp').then(function (response) {
...
function attemptVertx() {
  try {
    var r = require;
    var vertx = __webpack_require__(1216);
...
var _rcForm = __webpack_require__(1236);

var _Create = __webpack_require__(1237);

var _Create2 = _interopRequireDefault(_Create);

var _createAction = __webpack_require__(1238);

var allActions = _interopRequireWildcard(_createAction);
...
var createFormOption = {
    mapPropsToFields: function mapPropsToFields(props) {
        ...
        return {
            email: (0, _rcForm.createFormField)(props.createFormData.email)
        };
    },
...
//经过FORM HOC的处理
var CreateWithForm = _antd.Form.create(createFormOption)(_Create2.default);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(CreateWithForm);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createForm__ = __webpack_require__(531);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__createFormField__ = __webpack_require__(227);
...
var Create = function (_React$Component) {
  ...
  function Create() {
    ...
    var _this = _possibleConstructorReturn(this, (_ref = Create.__proto__ || Object.getPrototypeOf(Create)).call.apply(_ref, [this].concat(props)));
    ...
    console.log("sdfsdfds", _this.props);
    return _this;
  }
  ...
  _createClass(Create, [{
    ...
    value: function render() {
      ...
      var dates = (0, _moment2.default)("2015/08/01", 'YYYY/MM/DD');
      var config = {
        initialValue: dates,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          getFieldDecorator('date-picker', config)(_react2.default.createElement(_antd.DatePicker, null))
        ),
        _react2.default.createElement(
          FormItem,
          _extends({}, formItemLayout, {
          ...
          getFieldDecorator('date-time-picker', config)(_react2.default.createElement(_antd.DatePicker, { showTime: true, format: 'YYYY-MM-DD HH:mm:ss' }))
        ),
        _react2.default.createElement(
          FormItem,
          _extends({}, formItemLayout, {
        ...
        _react2.default.createElement(
          ...
          getFieldDecorator('time-picker', config)(_react2.default.createElement(_antd.TimePicker, null))
        ),
        _react2.default.createElement(
          FormItem,
          {
...
exports.changeFormValue = exports.save = exports.initHomeData = undefined;

var _actionsType = __webpack_require__(226);

var actionsType = _interopRequireWildcard(_actionsType);

var _Quest = __webpack_require__(1213);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

//初始化数据
var initHomeData = exports.initHomeData = function initHomeData() {};
//保存
var save = exports.save = function save(data, isFinish, callback) {
...
//表单数据改变
var changeFormValue = exports.changeFormValue = function changeFormValue(e) {
    var data = { value: e.target.value, name: e.target.name };
    return {
